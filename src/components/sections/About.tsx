      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="lg:col-span-7 border border-white/10 bg-black/60 backdrop-blur-md rounded-lg overflow-hidden h-fit shadow-2xl"
          >
            ...
            <div className="p-6 md:p-8 font-[var(--font-jetbrains-mono)] text-sm md:text-base text-gray-300 leading-relaxed space-y-6">
              <p>
